	...
	<div id="notfound">
		<div class="notfound">
			<div class="notfound-404">
				<img src="..//assets/img/uploads/minalin.png" style="margin-top: -235px;">
				<h1>500</h1>
			</div>
			<h2>Sorry, something went wrong...</h2>
			<p>We'll fix the problem as soon as possible. Please try again later.</p>
		</div>
	</div>
