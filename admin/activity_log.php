...
<head>
    ...
    <title>Activity Log | <?php echo $pages['page_website_title'];?></title>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="timeline">
                                <?php 
                                    $query = mySQLi_query($con, 'SELECT * FROM tbl_activitylog WHERE log_action != "SMS Send" order by log_id DESC') or die(mySQLi_error($con));
                                    $log_date = '';
                                ...
                                ?>
                                    ...
                                    <div>
                                        ...
                                        <?php if($log['log_action']=='Pensioner Applicant' || $log['log_action'] == 'Pensioner Active' || $log['log_action'] == 'Pensioner Deceased' || $log['log_action'] == 'Pensioner Rejected' || $log['log_action'] == 'Pensioner Deleted' 
                                            ...
                                            else if($log['log_action'] == 'Backup Auto'){echo '<i class="fas fa-stopwatch bg-gray"></i>';}
                                        ...
                                        <div class="timeline-item">
                                            ...
                                            <h3 class="timeline-header <?php if($log['log_action'] == 'Login' || $log['log_action'] == 'Logout' || $log['log_action'] == 'To Do Create' || $log['log_action'] == 'To Do Update' || $log['log_action'] == 'To Do Delete' || $log['log_action'] == 'Profile Details' || $log['log_action'] == 'Profile Password'
                                                    ...
                                                    || $log['log_action'] == 'Backup' || $log['log_action'] == 'Backup Upload' || $log['log_action'] == 'Restore' || $log['log_action'] == 'Backup Days' || $log['log_action'] == 'Backup Auto'
                                                ...
                                                else if($log['log_action'] == 'Account Inactive'){echo ' set '.$acc2['acc_role'].' as Inactive';}
                                                // Action Account Bulk
                                                ...
                                                else if($log['log_action'] == 'Backup Auto'){echo ' System auto backup performed successfully.';}
                                                // Purchase
                                                ...
                                                // Subscriber
                                                else if($log['log_action'] == 'Subscriber'){echo ' subscribed to the newsletter.';}
                                                // Delete Account
                                                ...
                                                <div class="timeline-body">
                                                    <?php if($log['log_action'] == 'Page Report Update Trashed' || $log['log_action'] == 'Page Report Update Draft' || $log['log_action'] == 'Page Report Update Published' || $log['log_action'] == 'Page Report Insert Draft' || $log['log_action'] == 'Page Report Insert Published'){ ?>
                                                        <table>
                                                            ...
                                                            <tr>
                                                                <td class="text-bold d-flex align-items-starts">Note: </td>
                                                                <td class="h6"><?php 
