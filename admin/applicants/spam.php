...
<head>
    ...
    <title>Spam | <?php echo $pages['page_website_title'];?></title>
        ...
        <div class="content-wrapper">
            ...
            <section class="content" id="pen_app_div">
                <form id="pen_app_form">
                    <div class="container-fluid">
                        <p>Note: Applicants with same name and address with current Pensioners(Active or Decease) or current Applicants will be marked as Spam.</p>
                        <!-- Success/Error -->
                        ...
                        <table id="tblDataTable" class="table table-hover">
                            ...
                            <tbody id="pen_app_table">
                                <?php
                                    $count = 1;
                                    $query=mySQLi_query($con, "SELECT * from tbl_applicants where appl_status = 'Spam' order by appl_id DESC") or die(mySQLi_error($con));
