<?php
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        // Drafts
            ...
            $_SESSION['queryPortfolios'] = "SELECT * from tbl_faqs where faq_status = 'Draft' order by faq_id DESC";
            $_SESSION['queryPortfoliosButton'] = 'Draft';
        // Trash
        }else if (isset($_POST['view_portfolio_trash'])) {
            $_SESSION['queryPortfolios'] = "SELECT * from tbl_faqs where faq_status = 'Trashed' order by faq_id DESC";
