...
<head>
    ...
    <title>Active Pensioners | <?php echo $pages['page_website_title'];?></title>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 mr-3">Active Pensioners</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                    ...
                    <div class="container-fluid">
                        <table id="tblDataTable" class="table table-hover">
                            ...
                            <tbody>
                                <?php
                                    $count = 1;
                                    $query=mySQLi_query($con, "SELECT * from tbl_applicants where appl_status = 'Active' order by appl_id DESC") or die(mySQLi_error($con));
        ...
        * Table Functions
        ...
        $("body").on('submit', '#pen_app_form', function(event){
            ...
            if($("input[name='appl_id[]']").is(":checked")){
                ...
                if(select_app_rej == 'Applicant'){title='Do you really want to move the selected applicant/s to pending?';toast_title='Successfully moved selected applicant/s to pending';btn='Move to pending'}
                else if(select_app_rej == 'Deceased'){title='Do you really want to move the selected applicant/s to deceased?';toast_title='Successfully moved selected applicant/s to deceased';btn='Move to deceased'}
                Swal.fire({
                    title: title,
