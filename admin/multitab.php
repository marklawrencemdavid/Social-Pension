...
<head>
    ...
    <title>Multi Tabs | <?php echo $pages['page_website_title'];?></title>
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed <?php if($acc['acc_darkmode'] == 1){echo 'dark-mode';} ?>" id="bodytag">
    <div class="wrapper">
        ...
        <div class="content-wrapper iframe-mode" data-widget="iframe" data-loading-screen="750">
            <div class="nav navbar navbar-expand <?php if($acc['acc_darkmode'] == 1){echo 'navbar-dark navbar-dark';}else{ echo 'navbar-white navbar-light';} ?> p-0">
                <div class="nav-item dropdown">
                    <a class="nav-link bg-danger dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Close</a>
                    <div class="dropdown-menu mt-0">
                        <a class="dropdown-item" href="#" data-widget="iframe-close" data-type="all">Close All Tabs</a>
                        <a class="dropdown-item" href="#" data-widget="iframe-close" data-type="all-other">Close All Other Tabs</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item text-danger" href="dashboard">Close Multi Tabs</a>
                    </div>
                </div>
                <a class="nav-link bg-<?php if($acc['acc_darkmode'] == 1){echo 'dark';}else{echo 'light';} ?>" href="#" data-widget="iframe-scrollleft"><i class="fas fa-angle-double-left"></i></a>
                <ul class="navbar-nav overflow-hidden" role="tablist"></ul>
                <a class="nav-link bg-<?php if($acc['acc_darkmode'] == 1){echo 'dark';}else{echo 'light';} ?>" href="#" data-widget="iframe-scrollright"><i class="fas fa-angle-double-right"></i></a>

                <a class="nav-link bg-<?php if($acc['acc_darkmode'] == 1){echo 'dark';}else{echo 'light';} ?>" href="#" data-widget="iframe-fullscreen"><i class="fas fa-expand"></i></a>
            </div>
